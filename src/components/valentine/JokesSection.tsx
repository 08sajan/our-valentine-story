...
const nepaliJokes: Joke[] = [
  ...
  { id: 'n7', setup: "छोरा: बुवा, म पहिलो आएँ!", punchline: "बुवा: कहाँ? छोरा: भागेर भर्खरै क्लास पुग्न! 🏃😂", category: 'funny' },
  ...
  { id: 'n11', setup: "एउटा मान्छे बैंकमा गयो।", punchline: "र बाहिर निस्कियो... किनभने ATM बन्द थियो! 🏦😂", category: 'funny' },
  { id: 'n12', setup: "के तिमी जादुगर हौ?", punchline: "किनभने तिमीलाई देख्दा सबै गायब हुन्छन्! ✨💕", category: 'love' },
  { id: 'n13', setup: "साथी: तिमीले किताब पढ्यौ?", punchline: "म: हो, cover मात्र! 📖😂", category: 'funny' },
  { id: 'n14', setup: "तिमी मेरो जिन्दगीको चिनी हौ।", punchline: "तिमीबिना जिन्दगी तीतो! 🍬💕", category: 'love' },
];
...
const hindiJokes: Joke[] = [
  ...
  { id: 'h7', setup: "पप्पू ने पूछा: सबसे अच्छा time pass क्या है?", punchline: "जवाब: Exam के वक्त पढ़ाई! 📝😂", category: 'funny' },
  ...
  { id: 'h15', setup: "पप्पू: मैं चाय नहीं पीता।", punchline: "टीचर: क्यों? पप्पू: क्योंकि मैं coffee पीता हूँ! ☕😂", category: 'funny' },
  { id: 'h16', setup: "तुम मेरी जान हो।", punchline: "इसलिए तुम्हारे बिना मैं बेजान! 💕😢", category: 'love' },
];
